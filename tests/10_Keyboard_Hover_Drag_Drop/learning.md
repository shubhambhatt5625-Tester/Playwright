...
- Keyboard: [https://playwright.dev/docs/api/class-keyboard](https://playwright.dev/docs/api/class-keyboard)
- Mouse: [https://playwright.dev/docs/api/class-mouse](https://playwright.dev/docs/api/class-mouse)
- Input actions: [https://playwright.dev/docs/input](https://playwright.dev/docs/input)
